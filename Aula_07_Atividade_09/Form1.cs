...
namespace Aula_07_Atividade_09
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            double rendimentoGuilherme = contaGuilherme.CalculaRendimentoAnual();
            MessageBox.Show("Rendimento por um ano do Guilherme. " + rendimentoGuilherme.ToString());
        }
    }
}
